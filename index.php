...
<div class="wrapper bgded overlay" class="bg-img">
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="txt-justify">Понятието „информационни технологии“ в съвременния си смисъл е използвано за пръв път през 1958 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="txt-justify">В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="txt-justify">Информационните технологии използват за обработка и съхранение на информация електронноизчислителни машини – компютри. 
